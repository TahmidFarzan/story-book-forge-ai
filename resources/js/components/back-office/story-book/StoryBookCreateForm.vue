...
function validateStep1() {
    ...
    if (
        step1Form.ai_brain_id === null ||
        step1Form.ai_brain_id === undefined ||
        step1Form.ai_brain_id === ""
    ) {
    ...
    if (
        step1Form.novel_continuity === null ||
        step1Form.novel_continuity === undefined ||
        step1Form.novel_continuity === ""
    ) {
    ...
    if (
        step1Form.language_id === null ||
        step1Form.language_id === undefined ||
        step1Form.language_id === ""
    ) {
    ...
    if (
        step1Form.audience_id === null ||
        step1Form.audience_id === undefined ||
        step1Form.audience_id === ""
    ) {
    ...
    if (
        !Array.isArray(step1Form.genre_ids) ||
        step1Form.genre_ids.length === 0
    ) {
        step1Form.setError("genre_ids", "At least one genre is required.");

        valid = false;
    }

    if (
        step1Form.story_book_type_id === null ||
        step1Form.story_book_type_id === undefined ||
        step1Form.story_book_type_id === ""
    ) {
        step1Form.setError(
            "story_book_type_id",
...
function submitStep1() {
    ...
    step1Form.post(route("back-office.novels.save"), {
        ...
        onSuccess: () => {
            completedSteps.value = new Set([...completedSteps.value, 1]);
...
const goNext = () => {
    if (activeStep.value >= STEP_DEFINITIONS.length) {
        return;
    }
        ...
        <div class="px-6 pt-4 border-b border-gray-200">
            <nav class="hidden md:flex overflow-x-auto pb-px">
                <button
                    ...
                    :disabled="
                        !isStepAccessible(step.id) && !isStepCompleted(step.id)
                    "
            ...
            <div v-if="activeStep === 1" class="space-y-6">
                <div class="bg-white border rounded-xl p-5 shadow-sm space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <InfiniteScrollApiSelect
                                ...
                                :selectedItem="step1Form.novel_continuity"
                                :apiUrl="
                                    route('search.story-book-continuities')
                                "
                                :multiple="false"
                            ...
                            <p
                                v-if="step1Form.errors.novel_continuity"
                        ...
                        <div>
                            ...
                            <InfiniteScrollApiSelect
                                ...
                                :selectedItem="step1Form.language_id"
                                :apiUrl="route('search.languages')"
                                :multiple="false"
                                placeholder="Select language"
                                :error="step1Form.errors.language_id"
                            />

                            <p
                                v-if="step1Form.errors.language_id"
                                class="text-red-500 text-sm mt-1"
                            >
                        ...
                        <div>
                            ...
                            <InfiniteScrollApiSelect
                                :form="step1Form"
                                fieldName="genre_ids"
                                :selectedItem="step1Form.genre_ids"
                                :apiUrl="route('search.genres')"
                                :multiple="true"
                                placeholder="Select genres"
                                :error="step1Form.errors.genre_ids"
                            />

                            <p
                                v-if="step1Form.errors.genre_ids"
                                class="text-red-500 text-sm mt-1"
                            >
                                {{ step1Form.errors.genre_ids }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <InfiniteScrollApiSelect
                                ...
                                :selectedItem="step1Form.story_book_type_id"
                                :apiUrl="route('search.story-book-types')"
                                :multiple="false"
                                placeholder="Select Story Book Type"
                                :error="step1Form.errors.story_book_type_id"
                            />

                            <p
                                v-if="step1Form.errors.story_book_type_id"
                                class="text-red-500 text-sm mt-1"
                            >
                                {{ step1Form.errors.story_book_type_id }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <InfiniteScrollApiSelect
                                ...
                                :selectedItem="step1Form.audience_id"
                                :apiUrl="route('search.audiences')"
                                :multiple="false"
                                placeholder="Select audience"
                                :error="step1Form.errors.audience_id"
                            />

                            <p
                                v-if="step1Form.errors.audience_id"
                                class="text-red-500 text-sm mt-1"
                            >
                                {{ step1Form.errors.audience_id }}
                            </p>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea
                                v-model="step1Form.additional_information"
                                rows="3"
                            ...
                            <p
                                v-if="step1Form.errors.additional_information"
                                class="text-red-500 text-sm mt-1"
                            >
                                {{ step1Form.errors.additional_information }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-6 pt-2">
                        ...
                        <label
                            ...
                            :class="{
                                'opacity-50': !step1Form.is_18_plus,
                            }"
                        >
                            <input
                                type="checkbox"
                                v-model="step1Form.enable_mature_content"
                        ...
                        <p
                            v-if="step1Form.errors.enable_mature_content"
                ...
                <div class="bg-white border rounded-xl p-5 shadow-sm space-y-4">
                    ...
                    <p class="text-sm text-gray-500">
                        Select the AI model that will be used for generating
                        your novel.
                    </p>
                    ...
                    >
                        <InfiniteScrollApiSelect
                            ...
                            :selectedItem="step1Form.ai_brain_id"
                    ...
                    <p
                        v-if="step1Form.errors.ai_brain_id"
