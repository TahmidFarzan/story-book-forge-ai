...
const worldVibeGeneratorForm = useForm({
...
const validate = () => {
    ...
    if (!worldVibeGeneratorForm.ai_brain_id) {
        worldVibeGeneratorForm.setError(
            "ai_brain_id",
...
const submit = () => {
    if (!isUpdate.value || worldVibeGeneratorForm.processing || !validate()) {
        return;
    }
...
<template>
    <div class="space-y-6">
        <div class="bg-white border rounded-xl p-5 shadow-sm space-y-4">
            <div>
                <p v-if="worldVibeGeneratorForm.errors.additional_information">
                    {{ worldVibeGeneratorForm.errors.additional_information }}
                </p>
            </div>
            ...
            <div>
                ...
                <textarea
                    v-model="worldVibeGeneratorForm.additional_information"
                    rows="3"
        ...
        <div class="bg-white border rounded-xl p-5 shadow-sm space-y-4">
            ...
            <p
                v-if="worldVibeGeneratorForm.errors.ai_brain_id"
                class="text-red-500 text-sm"
            >
                {{ worldVibeGeneratorForm.errors.ai_brain_id }}
            </p>
        </div>
        ...
        <div class="flex justify-end">
            <button
                type="button"
                @click="submit"
                :disabled="!isUpdate || worldVibeGeneratorForm.processing"
            ...
            >
                <FontAwesomeIcon
                    v-if="worldVibeGeneratorForm.processing"
                    icon="spinner"
                    spin
                />
                ...
                {{
                    worldVibeGeneratorForm.processing
                        ? "Generating..."
