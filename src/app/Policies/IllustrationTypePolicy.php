...
class IllustrationTypePolicy
{
    ...
    {
        $module = UserPermissionHelper::MODULE_ILLUSTRATION_TYPE;
        $access = UserPermissionHelper::ACCESS_VIEW_ANY;

        return $authUser->hasUserPermission($module, $access) ? Response::allow() : Response::deny();
    }

    public function view(User $authUser, IllustrationType $illustrationType): Response
    {
        $module = UserPermissionHelper::MODULE_ILLUSTRATION_TYPE;
    ...
    public function update(User $authUser, IllustrationType $illustrationType): Response
    {
        $module = UserPermissionHelper::MODULE_ILLUSTRATION_TYPE;
    ...
    public function delete(User $authUser, IllustrationType $illustrationType): Response
    {
