...
class StoryBookPolicy
{
    ...
    public function update(User $authUser, StoryBook $storyBook): Response
    {
        $module = UserPermissionHelper::MODULE_STORY_BOOK;
    ...
    public function delete(User $authUser, StoryBook $storyBook): Response
    {
