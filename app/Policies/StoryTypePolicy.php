...
class StoryTypePolicy
{
    ...
    public function update(User $authUser, StoryType $storyType): Response
    {
        $module = UserPermissionHelper::MODULE_STORY_TYPE;
    ...
    public function delete(User $authUser, StoryType $storyType): Response
    {
